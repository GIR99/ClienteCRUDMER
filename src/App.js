...
const addFriend = () => {
  Axios.post("https://frozen-badlands-35025.herokuapp.com/addFriend", {
    name : name,
    age : age,
...
const updateFriend = (id) => {
  ...
  Axios.put("https://frozen-badlands-35025.herokuapp.com/update", { newAge: newAge, newDescription : newDescription, id : id}).then(() => {
...
const deleteFriend = (id) =>{
  Axios.delete(`https://frozen-badlands-35025.herokuapp.com/delete/${id}`).then(()=>{
  ...
  useEffect(() => {
    Axios.get("https://frozen-badlands-35025.herokuapp.com/read")
    .then((response) => {
